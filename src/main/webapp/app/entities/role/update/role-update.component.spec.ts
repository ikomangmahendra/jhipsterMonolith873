...
describe('Role Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call UserSiteOrganisation query and add missing value', () => {
      const role: IRole = { id: 456 };
      const userSiteOrganisation: IUserSiteOrganisation = { id: 14150 };
      role.userSiteOrganisation = userSiteOrganisation;
      ...
      const additionalUserSiteOrganisations = [userSiteOrganisation];
