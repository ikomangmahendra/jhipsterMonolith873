...
import { sampleWithRequiredData } from '../user-temp.test-samples';
import { UserTempService } from '../service/user-temp.service';

import { UserTempComponent } from './user-temp.component';
import SpyInstance = jest.SpyInstance;

describe('UserTemp Management Component', () => {
  let comp: UserTempComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(UserTempComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userTemps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to userTempService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUserTempIdentifier');
      const id = comp.trackId(entity);
      expect(service.getUserTempIdentifier).toHaveBeenCalledWith(entity);
