...
public class Program implements Serializable {
    ...
    private Set<ProgramVersion> versions = new HashSet<>();
    ...
    public Set<ProgramVersion> getVersions() {
        return this.versions;
    }

    public void setVersions(Set<ProgramVersion> programVersions) {
        if (this.versions != null) {
            this.versions.forEach(i -> i.setProgram(null));
        }
        if (programVersions != null) {
            programVersions.forEach(i -> i.setProgram(this));
        }
        this.versions = programVersions;
    }

    public Program versions(Set<ProgramVersion> programVersions) {
        this.setVersions(programVersions);
        return this;
    }

    public Program addVersions(ProgramVersion programVersion) {
        this.versions.add(programVersion);
        programVersion.setProgram(this);
        return this;
    }

    public Program removeVersions(ProgramVersion programVersion) {
        this.versions.remove(programVersion);
        programVersion.setProgram(null);
        return this;
    }
