...
public class SiteOrganisation implements Serializable {
    ...
    public SiteOrganisation addUserSiteOrganisations(UserSiteOrganisation userSiteOrganisation) {
        this.userSiteOrganisations.add(userSiteOrganisation);
        userSiteOrganisation.setSiteOrganisation(this);
        return this;
    }

    public SiteOrganisation removeUserSiteOrganisations(UserSiteOrganisation userSiteOrganisation) {
