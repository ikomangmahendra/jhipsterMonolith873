...
class SiteOrganisationTest {
    ...
    @Test
    void userSiteOrganisationsTest() {
        ...
        siteOrganisation.addUserSiteOrganisations(userSiteOrganisationBack);
        ...
        siteOrganisation.removeUserSiteOrganisations(userSiteOrganisationBack);
